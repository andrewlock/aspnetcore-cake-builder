...
if [ ! -f "$CAKE_DLL" ]; then
    echo "<Project Sdk=\"Microsoft.NET.Sdk\"><PropertyGroup><OutputType>Exe</OutputType><TargetFramework>$CAKE_TARGET_FRAMEWORK</TargetFramework></PropertyGroup></Project>" > $TOOLS_PROJ
